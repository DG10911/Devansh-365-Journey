# Project-0813 — Camera Model & Lens Metadata Fingerprinter

## 📌 Description
Camera Model & Lens Metadata Fingerprinter — expert-level OSINT project involving people, infrastructure,
